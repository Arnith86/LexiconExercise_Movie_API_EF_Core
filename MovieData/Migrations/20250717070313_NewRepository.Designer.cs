...
namespace MovieData.Migrations
{
    ...
    [Migration("20250717070313_NewRepository")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieCore.Models.Entities.MovieActor", b =>
                {
            ...
            modelBuilder.Entity("MovieCore.Models.Entities.MovieGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieCore.Models.Entities.VideoMovie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieCore.Models.Entities.MovieActor", b =>
                {
                    b.HasOne("MovieCore.Models.Entities.Actor", "Actor")
                        .WithMany("MovieActors")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieCore.Models.Entities.VideoMovie", "Movie")
                        .WithMany("MovieActors")
            ...
            modelBuilder.Entity("MovieCore.Models.Entities.VideoMovie", b =>
                {
                    b.HasOne("MovieCore.Models.Entities.MovieGenre", "MoviesGenre")
                        .WithMany("Movies")
